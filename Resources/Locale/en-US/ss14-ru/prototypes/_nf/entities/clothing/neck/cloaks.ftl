...
ent-ClothingNeckCloakRosy = rosy the maple mothroach cloak
    .desc = A cloak made of pink and floof and roach.
ent-ClothingNeckCloakMiner = miner's cloak
    .desc = You move sixteen tons, and what do you get? This cloak. For the distinguished miner.
