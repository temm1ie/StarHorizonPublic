...
ent-UniformPrinterStaffMachineCircuitboard = staff uniform printer machine board
    .desc = A machine printed circuit board for a staff uniform printer.
ent-PirateStitcherCircuitboard = pirate stitcher machine board
    .desc = Clearly brand new.
...
ent-ImpCoffeeMachineCircuitboard = spacepresso machine board
    .desc = A machine printed circuit board for a spacepresso machine.
