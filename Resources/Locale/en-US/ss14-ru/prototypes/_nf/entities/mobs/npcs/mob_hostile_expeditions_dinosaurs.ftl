...
ent-TRexRoarGun = TRex Roar Gun
    .desc = Needed to emit the roar.
ent-ActionTRexRoar = [color=yellow]Roar[/color]
    .desc = Emits a powerful roar, intimidating and stunning nearby foe. [color=yellow]40 second cooldown.[/color]
