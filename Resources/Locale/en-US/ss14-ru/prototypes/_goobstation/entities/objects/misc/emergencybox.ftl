...
ent-BoxSurvivalSlotsOxygenExtended = extended-capacity survival box
    .desc = It's a box with basic internals inside. This one is labelled to contain an extended-capacity tank.
    .suffix = Extended
ent-BoxSurvivalSlotsNitrogenExtended = { ent-BoxSurvivalSlotsOxygenExtended }
    .suffix = Extended N2
    .desc = { ent-BoxSurvivalSlotsOxygenExtended.desc }
