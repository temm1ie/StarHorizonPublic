...
ent-TrackingImplant = tracking implant
    .desc = This implant has a condition monitor for the NFSD radio channel.
...
ent-RadioImplant = syndicate radio implant
...
ent-EmpImplant = EMP implant
    .desc = This implant creates a 2.75 m, 10 s, 2.7 MJ electromagnetic pulse when activated.
