...
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Получить доступную должность, если выбранная недоступна.
