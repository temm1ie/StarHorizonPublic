...
ui-options-bwoink-sound = Звук оповещений AHelp
...
ui-options-auto-fill-highlights = Автоматически заполнять выделения при помощи информации о персонаже
...
ui-options-hud-layout-separated = Раздельно
...
ui-options-function-swap-hands-reverse = Поменяйте руки (в другую сторону)
...
ui-options-function-inspect-entity = Осмотреть сущность
...
ui-options-function-text-tab-complete = Завершение табуляцией
ui-options-function-text-complete-next = Следующее завершение
ui-options-function-text-complete-prev = Предыдущее завершение
...
ui-options-admin-player-panel = Админ лист игроков
ui-options-admin-playerlist-separate-symbols = Показывать отдельные знаки для каждого типа роли антагониста
ui-options-admin-playerlist-character-color = Цветные имена персонажей антагонистов
...
ui-options-admin-player-tab-symbol-setting-specific = Показать конкретный символ антагониста
...
ui-options-admin-player-tab-color-setting-character = Раскрасить имена персонажей антагонистов
ui-options-admin-player-tab-color-setting-roletype = Раскрасить все типы ролей
ui-options-admin-player-tab-color-setting-both = Раскрасить и то, и другое
...
ui-options-admin-overlay-antag-symbol-specific = Показать конкретный символ антагониста
ui-options-admin-enable-overlay-playtime = Показать время игры
ui-options-admin-enable-overlay-starting-job = Показать начальную профессию
ui-options-admin-overlay-merge-distance = Дистанция объединения стека
ui-options-admin-overlay-ghost-fade-distance = Дистанция исчезновения оверлея призраков от мыши
ui-options-admin-overlay-ghost-hide-distance = Дистанция скрытия оверлея призраков от мыши
ui-options-enable-overlay-symbols = Добавить символ антагониста к тексту
ui-options-enable-overlay-playtime = Показать время игры
ui-options-enable-overlay-starting-job = Показать начальную профессию
ui-options-overlay-merge-distance = Дистанция объединения стека
ui-options-overlay-ghost-fade-distance = Дистанция исчезновения оверлея призраков от мыши
ui-options-overlay-ghost-hide-distance = Дистанция скрытия оверлея призраков от мыши
