...
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Латунные кастеты, сделанные по старинке, всё ещё бьют так же сильно.
ent-ClothingHandsKnuckleDustersQM = золотые кастеты квартирмейстера
    .desc = 24-каратное золото, смешанное с пласталем и украшенное логотипом Нанотрасен. Истинный символ могущества квартирмейстера.
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Пластитановые кастеты с кроваво-красным логотипом "S". Настоящий человек убивает с их помощью.
ent-ClothingHandsKnuckleDustersStun = оглушающие кастеты
    .desc = Пара кастетов, объединённых с технологией электрошоковой дубинки. Это делает избиение нарушителей намного проще.
ent-ClothingHandsKnuckleBoneCrushers = костедробители
    .desc = Благословлены богами, чтобы ломать всех, кто не подчиняется.
