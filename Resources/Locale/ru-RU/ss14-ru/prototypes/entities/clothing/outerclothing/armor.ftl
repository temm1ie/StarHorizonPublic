...
ent-ClothingOuterVestDetective = жилет детектива
    .desc = Бронированный жилет видавшего виды частного детектива.
...
ent-ClothingOuterArmorCentcommCarapace = панцирь ЦентКомма
    .desc = Бронированный нагрудник, обеспечивающий защиту и при этом обладающий максимальной мобильностью и гибкостью. Выдаётся только сотрудникам и агентам ЦентКомма.
