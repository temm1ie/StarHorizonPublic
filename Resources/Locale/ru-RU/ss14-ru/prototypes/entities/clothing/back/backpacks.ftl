...
ent-ClothingBackpackERTMedical = рюкзак врача ОБР
...
ent-ClothingBackpackCluwne = трясушкин фон трясхертон
    ...
    .suffix = Неснимаемый
ent-ClothingBackpackElectropack = электрозак
    .desc = Бьет током по сигналу. Используется для удержания под контролем особо опасного преступника.
