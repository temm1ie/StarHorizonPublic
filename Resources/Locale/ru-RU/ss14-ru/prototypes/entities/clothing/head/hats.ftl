...
ent-ClothingHeadHatBeretCommand = берет командования
    .desc = Берет с эмблемой командования. Он излучает ауру авторитета.
...
ent-ClothingHeadHatCanadaBeanie = канадская шапка
    .desc = Красная, белая и уютная. Она излучает домашнее тепло, если ваш дом холодный и наполнен кофейнями.
...
ent-ClothingHeadWehcellentCap = вехиколепная кепка
    .desc = Это была сетчатая кепка! Ассистенты носят их постоянно! На задней части есть отверстия для вентиляции, чтобы сохранять прохладу!
...
ent-ClothingHeadHatSolidHeadband = солидная головная повязка
    .desc = Вы почувствуете себя невидимым, надев это! (ОТКАЗ ОТ ОТВЕТСТВЕННОСТИ: НА САМОМ ДЕЛЕ НЕ ДЕЛАЕТ НОСИТЕЛЯ НЕВИДИМЫМ)
