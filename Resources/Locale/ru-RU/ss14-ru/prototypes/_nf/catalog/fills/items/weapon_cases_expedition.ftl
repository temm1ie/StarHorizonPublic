...
ent-WeaponCaseLongSm = { ent-WeaponCaseLong }
    .suffix = Подземелье, Soland-Moss AR
    .desc = { ent-WeaponCaseLong.desc }
...
ent-WeaponCaseLongTemperatureGunExpedition = { ent-WeaponCaseLong }
    .suffix = Подземелье, Температурная пушка
    .desc = { ent-WeaponCaseLong.desc }
