...
ent-StorageFillEVASuitParamedic = хранилище скафандра парамедика
    .desc = Содержит полный набор для выхода в открытый космос.
ent-StorageFillEVASuitParamedicAlt = { ent-StorageFillEVASuitParamedic }
    .desc = Содержит полный набор для выхода в открытый космос.
...
ent-StorageFillEVASuitPrivateSec = хранилище скафандра телохранителя
    .desc = Содержит полный набор для выхода в открытый космос.
ent-StorageFillEVASuitNfsd = хранилище скафандра ДШНФ
    .desc = Содержит полный набор для выхода в открытый космос.
...
ent-StorageFillEVASuitLvhi = { "" }
    .desc = Содержит стандартный внекорабельный комплект от Langstad-Voigt Heavy Industries (LVHI).
