...
ent-BoxColoredNavigationLighttube = коробка навигационных световых трубок
    .desc = Внутренняя часть коробки имеет такую форму, что в неё помещаются только световые трубки и лампочки. Она полна красных и зелёных огней. Празднично!
