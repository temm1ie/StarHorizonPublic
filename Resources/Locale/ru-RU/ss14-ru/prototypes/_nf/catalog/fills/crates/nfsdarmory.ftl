...
ent-CrateTrackingImplantsNfsd = ящик имплантов ДШНФ
...
ent-CrateTrainingBombsNfsd = ящик тренировочных бомб ДШНФ
