...
ent-PortableGeneratorDK = портативный генератор Д-К
    .desc =
        Прототип ядерного реактора Данн-Кикко. Используйте с осторожностью.
...
ent-PortableGeneratorDKJr = портативный генератор Д-К Мл.
    .desc =
        Миниатюрный ядерный реактор Данн-Кикко. Используйте с осторожностью.
