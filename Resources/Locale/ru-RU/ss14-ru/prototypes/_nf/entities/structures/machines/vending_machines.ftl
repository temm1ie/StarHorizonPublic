...
ent-VendingMachineNfsdDrobe = ДШНФдроб
    .desc = Элитная экипировка для сотрудников ДШНФ! Будьте в авангарде моды и безопасности с лучшей формой и снаряжением для защитников порядка.
...
ent-VendingMachineNfsdTech = ДШНФтех
...
ent-NFVendingMachineCart = ФронтирВенд
    .suffix = ПФ
    .desc = Всегда под рукой, когда нужно быстро выдать очередному авантюристу с деменцией новый КПК.
ent-NFVendingMachineCartNfsd = Рейнджер-О-Мат
    .suffix = ДШНФ
    .desc = Всегда под рукой, когда нужно быстро выдать очередному щиткуру с ПТРС новый КПК.
...
ent-VendingMachinePickNPack = Пик-н-Пак
    .desc = .desc = Оружие в ваши руки - с 2549 года.
...
ent-VendingMachineBoozePOI = { ent-VendingMachineBooze }
    ...
    .suffix = POI
ent-VendingMachineCuddlyCritterVendPOI = { ent-VendingMachineCuddlyCritterVend }
    .suffix = POI
    .desc = { ent-VendingMachineCuddlyCritterVend.desc }
ent-VendingMachineAutoTuneVendPOI = { ent-VendingMachineAutoTuneVend }
    .suffix = POI
    .desc = { ent-VendingMachineAutoTuneVend.desc }
...
ent-DEBUGVendingMachineMagazines = Все магазины
    .suffix = DEBUG, Магазины
    .desc = { ent-VendingMachineClothingPunk.desc }
ent-DEBUGVendingMachineAmmoBoxes = Все коробки патронов
    .suffix = DEBUG, Коробки патронов
    .desc = { ent-VendingMachineClothingPunk.desc }
