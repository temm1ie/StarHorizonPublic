...
ent-ComputerShipyardSecurity = консоль приёма в ДШНФ
...
ent-ComputerShipyardNfsd = консоль верфи ДШНФ
    .desc = Здесь вы можете приобрести патрульные шаттлы ДШНФ, оснащенные новейшими технологиями и готовые к самым сложным заданиям. Поддержите закон и порядок среди звезд, используя надежные и мощные шаттлы, созданные для настоящих героев.
