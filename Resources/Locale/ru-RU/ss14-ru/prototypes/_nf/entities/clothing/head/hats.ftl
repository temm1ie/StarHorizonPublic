...
ent-ClothingHeadHatNfsdBeretGreen = берет ДШНФ
    .desc = Берет помощника шерифа.
ent-ClothingHeadHatNfsdBeretBrown = берет ДШНФ
    .desc = Берет помощника шерифа.
ent-ClothingHeadHatNfsdBeretCream = берет ДШНФ
    .desc = Берет помощника шерифа.
ent-ClothingHeadHatNfsdCampaign = шляпа представителя ДШНФ
    .desc = Йаа-хууу, партнёр.
ent-ClothingHeadHatNfsdCampaignFilled = шляпа представителя ДШНФ
    .desc = Йаа-хууу, партнёр.
    .suffix = Заполненный
ent-ClothingHeadHatNfsdSmallCampaign = шляпа представителя ДШНФ
    .desc = Йаа-хууу, партнёр.
