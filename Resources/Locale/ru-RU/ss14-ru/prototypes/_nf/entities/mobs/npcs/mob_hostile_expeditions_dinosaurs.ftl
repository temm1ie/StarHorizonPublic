...
ent-MobDinosaurKentroExpeditions = кентозавр
    .suffix = Динозавр, Эксп
...
ent-TRexRoarGun = ревун Ти-рекса
    .desc = Необходим для издания рёва.
ent-ActionTRexRoar = [color=yellow]Рёв[/color]
    .desc = Издаёт мощный рёв, пугая и оглушая ближайших противников. [color=yellow]Перезарядка: 40 секунд.[/color]
