...
ent-FoodEveryspice = коробочки душистого перца
    .desc = Длинные бледные коробочки растения душистого перца. При измельчении придают еде яркий вкус.
ent-FoodEveryspiceRoasted = жареные коробочки душистого перца
    .desc = Ароматные, обожжённые коробочки растения душистого перца. При измельчении придают еде пикантный вкус.
ent-FoodOnionRingsBattered = луковые кольца в кляре
    .desc = Луковые кольца, обмакнутые в густую смесь из муки и яйца.
ent-FoodMonkanana = обезьянан
    .desc = Выглядит как обезьяноподобный банан.
