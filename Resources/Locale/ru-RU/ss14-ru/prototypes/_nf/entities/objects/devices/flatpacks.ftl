...
ent-GeneratorRTGDamagedFlatpack = упаковка РИТЭГа
    .suffix = Повреждённый
    .desc = Упаковка, используемая для сборки РИТЭГа. Упаковка выглядит повреждённой...
...
ent-GravityGeneratorMiniFlatpack = упаковка мини-генератора гравитации
...
ent-CutterMachineFlatpack = упакованный резак
    .desc = Упаковка, при помощи которой можно создать резательный станок.
...
ent-ShuttleGunMailLauncherFlatpack = упакованный FWD-6500m "Приоритет"
    .desc = Упаковка, при помощи которой можно создать стационарный почтовый пускатель FWD-6500m "Приоритет".
...
ent-DrumsetInstrumentFlatpack = упакованная ударная установка
    .desc = Упаковка, содержащая ударную установку.
ent-OreProcessorFuelFlatpack = упаковка топливного преобразователя
    .desc = Плоская упаковка для сборки топливного преобразователя.
ent-PortableGeneratorStarPacmanFlatpack = упаковка портативного генератора Star Pacman
    .desc = Плоская упаковка для сборки портативного генератора Star Pacman.
ent-NfsdTechFabFlatpack = упакованный техфаб ДШНФ
    .desc = Упаковка, содержащая техфаб ДШНФ.
...
ent-HoverbikeMailcarrierFlatpack = упакованный ховербайк почтальона
    .desc = Упаковка, содержащая ховербайк. Ключи в комплекте.
ent-HoverbikeNfsdFlatpack = упакованный ховербайк ДШНФ
    .desc = Упаковка, содержащая ховербайк. Ключи в комплекте.
...
ent-MobileComputerTabletopCommsFlatpack = упакованная коммуникационная консоль
    .desc = Упаковка, при помощи которой можно создать коммуникационную консоль.
