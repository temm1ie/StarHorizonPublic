...
ent-PosterLegitNoTouching = Не трогать
    .desc = Не трогать!
ent-PosterLegitChknDnnr = Победитель получает куриный обед
    .desc = Реклама хрустящей жареной курицы.
ent-PosterLegitCornzza = Корочка из кукурузных початков!
    .desc = НОВАЯ Корнцца! Кукурузная пицца с корочкой из кукурузных початков, от которой вы скажете: "Зачем это существует?".
ent-PosterContrabandSafetyMothSyndie = Синдимоль — Ядерная операция
    .desc = Syndie Moth™ советует зрителю держать диск ядерной аутентификации незащищённым. "Мир никогда не был вариантом!"
ent-PosterLegitSafetyMothPoisoning = Safety Moth — Отравление
    .desc = Safety Moth™ предупреждает зрителя не отравлять станционные пончики.
ent-PosterLegitSafetyMothBoH = Safety Moth — Сумка хранения
    .desc = Safety Moth™ информирует зрителя об опасностях сумок хранения. "Помните! Сумки хранения могут быть красивыми, но они также довольно опасны! Никогда не кладите одну внутрь другой!"
ent-PosterLegitSafetyMothFires = Safety Moth — Пожары
    .desc = Safety Moth™ пропагандирует безопасное обращение с плазмой и рекомендует держать противопожарное оборудование под рукой.
ent-PosterLegitSafetyMothPills = Safety Moth — Флаконы с таблетками
    .desc = Safety Moth™ информирует зрителя, что оставление таблеток без присмотра на столах может привести к непредвиденным последствиям. "Голодные твари любят есть всё подряд! Храните свои таблетки в безопасности в ящиках и флаконах!"
