...
rmc-attachable-shoot-fail-not-wielded = { CAPITALIZE($holder) } должен быть экипирован, чтобы стрелять из { $attachable }!
...
rmc-attachable-examine-condition-active = { $attachable } [bold]активен[/bold]
rmc-attachable-examine-condition-inactive = { $attachable } [bold]неактивен[/bold]
