...
department-NFCommand-description = Управление сектором, эффективное ведение дел.
department-NFCentralCommand-description = Держите сектор под контролем, заставляйте командование быть начеку.
department-NFSecurity-description = Сохраняйте мир в секторе.
