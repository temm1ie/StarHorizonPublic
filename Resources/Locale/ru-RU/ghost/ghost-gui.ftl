...
ghost-gui-toggle-lighting-manager-popup-normal = Освещение нормально.
ghost-gui-toggle-lighting-manager-popup-personal-light = Личный свет.
...
ghost-gui-toggle-hearing-popup-off = Теперь вы слышите только радио и ближайшие сообщения.
