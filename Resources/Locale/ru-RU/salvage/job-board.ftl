salvage-job-rank-title-0 = [color=gray]Утилизатор[/color]
salvage-job-rank-title-1 = [color=white]Металлист[/color]
salvage-job-rank-title-2 = [color=yellow]Специалист[/color]
salvage-job-rank-title-MAX = [color=gold]Верховный утилизатор[/color]
job-board-radio-announce = Ранг утилизатора повышен до [bold]{ $rank }[/bold]! Новые задания доступны в отделе снабжения.
...
salv-job-board-name-BountyTeethSharkminnow = Карпокула
...
bounty-description-remains = Нужно взять несколько ядер повелителя роя. Если ядро не уничтожить, они размножаются бесконечно. Не дайте им захватить вас.
bounty-description-plates = Нужно достать пару шкур голиафа. Они медлительны, но будьте осторожны с щупальцами — схватят и утащат на землю. Последствия лучше не знать.
bounty-description-diamond = Требуются несколько алмазов для продвинутого изготовления. Их можно найти на близлежащем астероиде или добыть из василиска. Делайте как удобнее.
