...
plant-holder-component-early-sample-message = Из этого растения ещё рано извлекать семена!
...
plant-holder-component-something-already-growing-message = Здесь проростают семена [color=green]{ $seedName }[/color].
