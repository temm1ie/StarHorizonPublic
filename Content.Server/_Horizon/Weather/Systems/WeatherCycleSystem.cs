...
namespace Content.Server._Horizon.Weather;
...
public sealed class WeatherCycleSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<WeatherCycleComponent>();
    ...
    private bool HasWeather(WeatherCycleComponent comp, int stage)
    {
        if (stage < 0)
