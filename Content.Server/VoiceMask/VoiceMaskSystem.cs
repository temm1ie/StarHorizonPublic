...
public sealed partial class VoiceMaskSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        InitializeBarks(); // _Horizon Barks
    ...
    private void UpdateUI(Entity<VoiceMaskComponent> entity)
    {
        if (_uiSystem.HasUi(entity, VoiceMaskUIKey.Key))
            _uiSystem.SetUiState(entity.Owner, VoiceMaskUIKey.Key, new VoiceMaskBuiState(GetCurrentVoiceName(entity), entity.Comp.BarkId, entity.Comp.BarkPitch, entity.Comp.VoiceMaskSpeechVerb)); // _Horizon
    }
    #endregion
