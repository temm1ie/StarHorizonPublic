...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly SponsorShopUIController _sponsorShop = default!;  // Horizon
    [Dependency] private readonly LanguageMenuUIController _language = default!;    // Horizon
    ...
    public void UnloadButtons()
    {
        ...
        _sponsorShop.UnloadButton();    // Horizon
        _language.UnloadButton();   // Horizon
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _sponsorShop.LoadButton();  // Horizon
        _language.LoadButton(); // Horizon
    }
}
