...
public sealed class SurgeryBui : BoundUserInterface
{
    ...
    [Dependency] private readonly IGameTiming _game = null!;
    ...
    private readonly List<EntProtoId> _previousSurgeries = [];
    ...
    private void Update(SurgeryBuiState state)
    {
        ...
        foreach (var part in parts)
        {
            ...
            foreach (var (surgeryId, _, _) in surgeries)
            {
