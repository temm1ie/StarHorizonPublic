using Content.Shared._Horizon.SeedDna;
using Content.Shared.Containers.ItemSlots;
using static Content.Shared._Horizon.SeedDna.Components.SeedDnaConsoleComponent;

namespace Content.Client._Horizon.SeedDna.UI;
