...
namespace Content.Client._Horizon.UserInterface.RichText;
...
public sealed class ToggleableFontTag : IMarkupTagHandler
{
        ...
        string fontId)
    {
        ...
        if (cfg.GetCVar(HorizonCCVars.EnableCustomFonts))
        {
